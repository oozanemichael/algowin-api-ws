...
class BinanceUserDataChannel implements AutoCloseable {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(org.mh.exchange.binance.BinanceUserDataChannel.class);
  ...
  /**
   * Thrown on calls to {@link org.mh.exchange.binance.BinanceUserDataChannel#getListenKey()} if no channel is currently
   * open.
   *
   * @author Graham Crockford
   */
